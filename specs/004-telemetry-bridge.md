...
> observability backend the operator configures (Langfuse, Phoenix,
> Datadog, etc.). The **NATS JetStream bus feeding the pipeline below
> is also Layer 2**: `charts/fabric` ships no message bus.
