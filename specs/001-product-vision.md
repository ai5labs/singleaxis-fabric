...
| **Services** (SingleAxis) | Regulated enterprises who want the outcome (audit-ready, evidenced) not the operational burden | Layer 1 + SingleAxis's internal tooling + implementation + rubric authoring + managed operations + evidence preparation | ***REDACTED*** — see [spec 013](013-design-partner-model.md) |

The OSS door is the ***REDACTED***. The services door is the revenue.
...
## ***REDACTED*** for SingleAxis

Fabric changes the ***REDACTED*** of SingleAxis's existing consulting,
on a phased schedule tied to customer count
([spec 012](012-oss-commercialization-strategy.md)):

- **Phase 1 (Foundation):** ***REDACTED***.
  Fabric Layer 1 is the ***REDACTED***; Layer 2 internal tooling makes
  each engagement efficient. ***REDACTED*** — same business, better
  delivery instrument.
- **Phase 2 (Broaden):** ***REDACTED***. Some
  Layer 2 tooling is billable as managed-service retainer. Revenue
  mix shifts toward recurring.
- **Phase 3 (Stability and GA):** ***REDACTED***. Evidence bundles,
...
existing one — with ***REDACTED*** on the horizon as the
services business ***REDACTED***.
