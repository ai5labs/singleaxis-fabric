...
**customer signal** (SingleAxis's own paying services customers), not
...
## Phase 1 — Zero to three paying customers (current)
...
## Phase 2 — Three to ten paying customers
...
- Pattern library stabilizes as customer count provides statistical
  signal
...
- **Entry:** design partner #3 reaches Stage D.
- **Exit:** ten customers in managed operation; pattern library stable
  enough to productize in Phase 3.

## Phase 3 — Ten-plus paying customers, productization

**Goal:** Layer 2 productizes into a commercial offering; Layer 3
...
- **Exit:** Layer 3 product in use by at least three paying customers;
...
| SingleAxis services capacity bottlenecks Phase 1 | Capacity cap of three design partners concurrently ([spec 013](013-design-partner-model.md)). Don't oversell. |
